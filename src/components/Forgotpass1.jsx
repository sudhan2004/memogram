    ...
    return (
        ...
        <Card elevation={5}>
          <div style={{backgroundColor: "#D9D9D9",paddingBottom:40}}>
            ...
            <h6 style={{marginLeft: 40}}>Email or Phone Number</h6>
            <div className='k2'><TextField fullWidth variant="outlined" size='small'/></div>
            <div align="center"><Link style={{textDecoration:"none"}} to={'/Forgotpass2'}><Button style={{textTransform:"none",color:"black",backgroundColor:"#1E7E44",width: 300}} type='Submit'>Send OTP</Button></Link></div>
            <div className='k41'>
