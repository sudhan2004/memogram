    ...
    return (
      <div>
        ...
        <Card elevation={3} style={this.cardstyle }>
            ...
            <Link style={{textDecoration:"none"}} to={'/'}><img src={logout} alt="Logo" style={{width:"100%",height:"100%",marginTop:'13%',}} /></Link>
      ...
      <Card variant="outlined" elevation={3}style={this.newcardstyle}>
        ...
        <img src={homeimg} alt="Logo" style={{width:"100%",height:"auto"}} />
        {/* <Box
  sx={{
    width: 300,
    height: 300,
...
<Checkbox style={this.wish }{...label} icon={<FavoriteBorder />}  checkedIcon={<Favorite /> } size="large"sx={{
  ...
  <Checkbox style={this.icon }
      ...
      <div style={{paddingLeft:850,paddingTop: -200,marginTop:-40}}><Link to={'/home2'}><img src={nextmeme} alt="nextmeme" style={{height:"50px",paddingLeft:"70%",marginTop:"-40%"}} /></Link></div>
