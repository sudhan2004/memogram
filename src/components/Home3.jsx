...
import home3img from './images/home3img.png'
  ...
  render() {
    return (
      ...
      <Card variant="outlined" elevation={3}style={this.newcardstyle}>
        {/* <Avatar src="logo.png"/>
        <h1>fshlfhsklfhsklllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll</h1> */}
        <img src={home3img} alt="Logo" style={{width:"100%",height:"auto"}} />
        {/* <Box
  sx={{
    width: 300,
    height: 300,
...
<Checkbox style={this.wish }{...label} icon={<FavoriteBorder />}  checkedIcon={<Favorite /> } size="large"sx={{
  ...
  <Checkbox style={this.icon }
      ...
      <div style={{paddingLeft:510,paddingTop: -150,marginTop:-30}}><Link style={{textDecoration:"none"}} to={'/Home2'}><img src={previous} alt="previosmeme" style={{height:"50px",paddingLeft:"5%",marginTop:"-25%",marginBottom:"5%"}} /></Link></div>

      <div style={{paddingLeft:850,paddingTop: -200,marginTop:-40}}><img src={nextmeme} alt="nextmeme" style={{height:"50px",paddingLeft:"70%",marginTop:"-40%"}} /></div>
